...
public class VignetteShader_Resources_default_InlineClientBundleGenerator implements org.parallax3d.parallax.graphics.renderers.plugins.postprocessing.shaders.VignetteShader.Resources {
  private static VignetteShader_Resources_default_InlineClientBundleGenerator _instance0 = new VignetteShader_Resources_default_InlineClientBundleGenerator();
  private void getFragmentShaderInitializer() {
    getFragmentShader = new org.parallax3d.parallax.system.SourceTextResource() {
      // jar:file:/Users/alfonso/.m2/repository/org/parallax3d/parallax/parallax-renderer-plugins/2.0-SNAPSHOT/parallax-renderer-plugins-2.0-SNAPSHOT-sources.jar!/org/parallax3d/parallax/graphics/renderers/plugins/postprocessing/shaders/source/vignette.fs.glsl
      public String getText() {
        return "uniform float offset;\nuniform float darkness;\n\nuniform sampler2D tDiffuse;\n\nvarying vec2 vUv;\n\nvoid main() {\n\n	// Eskil's vignette\n\n	vec4 texel = texture2D( tDiffuse, vUv );\n	vec2 uv = ( vUv - vec2( 0.5 ) ) * vec2( offset );\n	gl_FragColor = vec4( mix( texel.rgb, vec3( 1.0 - darkness ), dot( uv, uv ) ), texel.a );\n\n\n	// alternative version from glfx.js\n	// this one makes more \"dusty\" look (as opposed to \"burned\")\n\n	// vec4 color = texture2D( tDiffuse, vUv );\n	// float dist = distance( vUv, vec2( 0.5 ) );\n	// color.rgb *= smoothstep( 0.8, offset * 0.799, dist *( darkness + offset ) );\n	// gl_FragColor = color;\n}";
      }
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      case 'getFragmentShader': return this.@org.parallax3d.parallax.graphics.renderers.plugins.postprocessing.shaders.VignetteShader.Resources::getFragmentShader()();
      case 'getVertexShader': return this.@org.parallax3d.parallax.graphics.renderers.plugins.postprocessing.shaders.VignetteShader.Resources::getVertexShader()();
    }
    return null;
  }-*/;
}
