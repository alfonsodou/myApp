...
public class MyAnimation extends AnimationAdapter implements TouchMoveHandler {
	...
	public void onStart(RenderingContext context) {
		...
		final MeshPhongMaterial material = new MeshPhongMaterial().setSpecular(0xffffff).setShininess(100)
	...
	public void onUpdate(RenderingContext context) {
		...
		particleLight.getPosition().set(Math.cos(timer * 7) * 100, Math.sin(timer * 5) * 200,
